...
mv $ALD/Settingsmenu/printmgr.desktop	$RPM_BUILD_ROOT%{_desktopdir}/kde
...
#
%{_libdir}/kde3/libkcm_randr.la
%attr(0755,root,root) %{_libdir}/kde3/libkcm_randr.so
#
...
%{_desktopdir}/kde/xinerama.desktop
